<script>
    ...
    <?php
        $jsData['prefectures'] = getFormdata('prefectures');
        $jsData['city'] = getFormdata('city');
        if(!empty($jsData['prefectures'])) :
    ?>
        $(function(){
            $("#prefectures").val("<?php echo $jsData['prefectures']; ?>");
            $("#city").val("<?php echo $jsData['city']; ?>");
        });
    <?php endif; ?>
